...
func (m *MovieModel) GetAll(title string, genre []string, filters Filters) ([]*Movie, Metadata, error) {
	query := fmt.Sprintf(`
	...
	args := []interface{}{title, pq.Array(genre), filters.limit(), filters.offset()}
...
func (m *MovieModel) Insert(movie *Movie) error {
	...
	args := []interface{}{movie.Title,
		movie.Year, movie.Runtime, pq.Array(movie.Genres)}
